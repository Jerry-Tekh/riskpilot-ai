"""Entry point for the RiskPilot Adaptive Regime Playbook.
...
signal_only and backtest-focused; we handle the historical path here.
"""
import math
...
def run() -> None:
    ...
    runtime.emit_signal(
        ...
        meta={
            ...
            "thesis": "adaptive regime: trend-follow, mean-revert, or stay flat",
